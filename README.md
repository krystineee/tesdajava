...
*Retail Banking and Integrating Systems Department – Data Integration Support Unit*

(August 2025 – September 2025)

- Developed a predictive analytics model to support data-driven decision-making.
- Performed data preprocessing, feature selection, and feature engineering to improve model performance.
- Applied machine learning techniques to analyze structured datasets.
